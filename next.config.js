...
const nextConfig = {
  ...
  env: {
    ...
    // Note: Server-side env vars (PhonePe, Razorpay, etc.) are accessed via process.env at runtime
    // They don't need to be listed here as they're not used client-side
  },
